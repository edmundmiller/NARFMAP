...
extern "C" {
    pub fn getHashCfgError() -> *const ::std::os::raw::c_char;
}
extern "C" {
    pub fn getBuildHashTableCmdline(
        binFile: *const ::std::os::raw::c_char,
        liftoverFile: *const ::std::os::raw::c_char,
    ) -> *const ::std::os::raw::c_char;
}
extern "C" {
    pub fn writeHashCfgBin(
        filename: *const ::std::os::raw::c_char,
        config: *const hashTableConfig_t,
    );
}
extern "C" {
    pub fn writeHashCfgTxt(
        filename: *const ::std::os::raw::c_char,
        config: *const hashTableConfig_t,
    );
}
extern "C" {
    pub fn readHashCfgBin(
        filename: *const ::std::os::raw::c_char,
        config: *mut hashTableConfig_t,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn readHashCfgTxt(
        filename: *const ::std::os::raw::c_char,
        config: *mut hashTableConfig_t,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn isOldHashTable(filename: *const ::std::os::raw::c_char) -> ::std::os::raw::c_int;
}
